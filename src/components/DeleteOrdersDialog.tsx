...
export function DeleteOrdersDialog({
  ...
  const t = {
    es: {
      confirmTitle: '¿Eliminar pedidos?',
      confirmDescSingle: `¿Estás seguro de que deseas eliminar ${orderIds.length} pedido(s)?`,
      confirmDescAll: '¿Estás seguro de que deseas eliminar TODOS los pedidos?',
      confirmWarning: 'Esta acción no se puede deshacer. Se eliminarán los pedidos y sus items asociados.',
      cancel: 'Cancelar',
      continue: 'Continuar',
      ...
      deleteSuccess: 'Pedidos eliminados correctamente',
    },
    en: {
      confirmTitle: 'Delete orders?',
      confirmDescSingle: `Are you sure you want to delete ${orderIds.length} order(s)?`,
      confirmDescAll: 'Are you sure you want to delete ALL orders?',
      confirmWarning: 'This action cannot be undone. Orders and their associated items will be deleted.',
      cancel: 'Cancel',
      continue: 'Continue',
      ...
      deleteSuccess: 'Orders deleted successfully',
    },
  };
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('send-delete-otp', {
        body: { orderIds, deleteAll },
      });
